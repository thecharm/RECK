...
class SentenceREDataset(data.Dataset):
    ...
    def __init__(self, text_path, pic_path, rel2id,
        ...
        Args:
            ...
            tokenizer: function of tokenizing
            glove: function of concept features mapping
        """
        ...
        self.concept_path = './data/concept_data/%s_0-%s_t2v_entity.json' % (mode, str(num_))
        self.concept_path_rev = './data/concept_data/%s_0-%s_v2t_entity.json' % (mode, str(num_))
